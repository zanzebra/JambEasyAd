...
export const LandingPage = ({ setShowModal, setShowNav, showNav }) => {
  return (
    <Fragment>
      <Helmet>
        <title>Jamb Easy Landing Page</title>
        <meta
          name="description"
          content="A preview to a wonderful experience"
        />
        <meta name="theme-color" content="#008f68" />
        <meta property="og:title" content="JambEasy Landing page" />
        <meta
        ...
        <meta
          property="og:image"
          content="https://i.ibb.co/t88Lfx7/jamblogo3.png"
        />
      </Helmet>
      ...
      <div style={{ background: "transparent" }}>
        ...
        <div className="content">
          ...
          <div className="follow-div">
            ...
            <span className="socials" style={{ zIndex: 100 }}>
              <a
                href="https://web.facebook.com/jambeazy"
                target="_blank"
	...
	c21.809,0,39.49-17.682,39.49-39.491V148.956C402.533,127.147,384.852,109.466,363.043,109.466z"
              ...
              <a
                href="https://twitter.com/EasyJamb"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
	...
	v-0.964c0-3.241,1.465-6.291,4.024-8.37c9.706-7.882,18.16-17.158,25.122-27.572C403.796,164.578,400.896,161.13,397.872,162.471z"
              ...
              <a
                href="https://linkedin.com/in/zanzebra"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
